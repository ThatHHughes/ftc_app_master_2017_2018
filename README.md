## Welcome!
This GitHub repository contains FTC Team 3033 code, that is used to build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK, download/clone the entire project to your local computer.
...
Team coders can use this repository to gain access to relevant code for the robot or to learn about programming FTC bots. If you are editing the code for competition, please do so on our ICE Coder site, the link to which should be given to you by our programming captain. 
